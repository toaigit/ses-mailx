...
dnl #
dnl # Added the following two lines for AWS SES - toaivo
...
dnl #  Enabled the following line - toaivo
...
dnl #   added the following line - toaivo
...
dnl #
dnl #  Updated the following line with the right domain - toaivo
MASQUERADE_AS(`resourceonline.org')dnl
dnl #
